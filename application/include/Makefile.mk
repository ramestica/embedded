...
TARGET_INCLUDE=$(CMSIS_ROOT)/CMSIS/Core/Include:$(CMSIS_ROOT)/CMSIS/DSP/Include:$(TIVA_WARE_C_ROOT)
...
#
# Use rtags to index c/c++ source code, the following is the name of the shell
# command, flags, used for that purpose.
#
RTAGS = rc
RTAGS_FLAGS = -c
