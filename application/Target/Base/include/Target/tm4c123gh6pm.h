...
#include <Target/system_tm4c123gh6pm.h>                    /*!< TM4C123GH6PM System                                                   */
...
typedef struct {                                    /*!< GPIOA Structure                                                       */
    /* the GPIOA_Type structure is wrong for the DATA field, which should be an array of 256 words at the start of the struct, rather than a single word after 255 words of padding */
    /* http://forum.43oh.com/topic/7414-understanding-arm-based-controller-stellaris-through-driverlib-or-through-registers/page-2 */
...
typedef struct {                                    /*!< WTIMER0 Structure                                                     */
  ...
  __I  uint32_t  RESERVED1[981];
  __IO uint32_t  PP;                                /*!< GPTM Peripheral Properties                                            */
} WTIMER0_Type_NOT_USED; /* I do not understand why it was actually defined. */
...
#define WTIMER0                         ((TIMER0_Type             *) WTIMER0_BASE)
...
/*                                                                            */
/******************************************************************************/
/*********** Bit definition for GPTM Run-Mode Clock Configuration *************/
#define SYSCTL_RCC_USEPWMDIV (0x1ul << 20) //Enable PWM Clock Divisor
#define SYSCTL_RCC_PWMDIV_B  (17)          // PWM Unit Clock Divisor (mask start)
#define SYSCTL_RCC_PWMDIV_M  (0x7ul << 17) // PWM Unit Clock Divisor (mask, 3 bits) 
...
/*                                                                            */
/******************************************************************************/
/*********** Bit definition for GPTM Control register ********************/
#define GPTM_CTL_TAEN (0x1ul << 0)      // Timer A Enable
#define GPTM_CTL_TBEN (0x1ul << 8)      // Timer B Enable
#define GPTM_CTL_TAEVENT (0x3ul << 2)   // Timer A Event Mode
#define GPTM_CTL_TBEVENT (0x3ul << 10)  // Timer B Event Mode    
/*********** Bit definition for GPTM Mode register ***********************/
#define GPTM_TAMR_TAPWMIE (0x1ul << 9)  // PWM Interrupt Enable
#define GPTM_TBMR_TBPWMIE (0x1ul << 9)  // PWM Interrupt Enable
#define GPTM_TAMR_TACDIR  (0x1ul << 4)  // Count Direction  
#define GPTM_TBMR_TBCDIR  (0x1ul << 4)  // Count Direction
#define GPTM_TAMR_TACMR   (0x1ul << 2)  // Capture Mode
#define GPTM_TBMR_TBCMR   (0x1ul << 2)  // Capture Mode
/*********** Bit definition for GPTM Interrupt Mask register **********************/
#define GPTM_IMR_TAMIM    (0x1ul << 4)  // Match Interrupt Mask
#define GPTM_IMR_TBMIM    (0x1ul << 11) // Match Interrupt Mask
#define GPTM_IMR_CAEIM    (0x1ul << 2)  // Capture Mode Event Interrupt Mask
#define GPTM_IMR_CBEIM    (0x1ul << 10) // Capture Mode Event Interrupt Mask
#define GPTM_IMR_TATOIM   (0x1ul << 0)  // Time-Out Interrupt Mask
#define GPTM_IMR_TBTOIM   (0x1ul << 8)  // Time-Out Interrupt Mask
/*********** Bit definition for GPTM Masked Interrupt Status register *************/
#define GPTM_MIS_TAMMIS   (0x1ul << 4)  // Match Masked Interrupt
#define GPTM_MIS_TBMMIS   (0x1ul << 11) // Match Masked Interrupt
#define GPTM_MIS_TATOMIS  (0x1ul << 0)  // Time-Out Masked Interrupt
#define GPTM_MIS_TBTOMIS  (0x1ul << 8)  // Time-Out Masked Interrupt
...
/*                                                                            */
/******************************************************************************/
/*********** Bit definition for UART Data register ********************/
/*********** Bit definition for UART Receive Status register *********/
/*********** Bit definition for UART Error Clear register ************/
/*********** Bit definition for UART Flags register *********************/
#define UART_FR_TXFE (0x1ul << 7)       // Transmit FIFO Empty
#define UART_FR_RXFE (0x1ul << 4)       // Receive FIFO Empty
...
#define UART_MIS_RTMIS (0x1ul <<  6)    // Receive Time-Out
#define UART_MIS_TXMIS (0x1ul <<  5)    // Transmit passing through FIFO level or EOT
#define UART_MIS_RXMIS (0x1ul <<  4)    // Receive passing through FIFO level
...
/*                                                                            */
/******************************************************************************/
/*********** Bit definition for MCR Master Configuration register *************/
#define I2C_MCR_MFE   (0x1ul << 4)  // Master Function Enable
/*********** Bit definition for MCS Master Control/Status register ************/
#define I2C_MCS_ERROR (0x1ul << 1)  // Controller error state
#define I2C_MCS_BUSY  (0x1ul << 0)  // Controller busy state
...
/*                                                                            */
/******************************************************************************/
/*********** Bit definition for PWMnCTL Signal Generator Configuration register */
#define PWM_n_CTL_ENABLE (0x1ul << 0) // Block Enable
